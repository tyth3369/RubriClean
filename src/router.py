"""
RubriClean Router — 逐页自适应版本路由

Analyze page characteristics and automatically select the best processing version:
- Crossing-heavy pages (dense handwriting + red corrections) → Bridge v1.2
- Paper-red pages (sparse text, red marks on paper) → Deep

No unified algorithm. Just smart routing at the page level.
"""
import cv2
import numpy as np
